    ...
    <div x-data="{ addModal: false }">
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                <h1 class="text-2xl text-gray-800 pb-6">Departement</h1>
            </div>
                    ...
                    <div class="flex flex-col lg:items-center lg:justify-between gap-4">
                        ...
                        <div class="flex flex-col lg:flex-row w-full justify-between gap-3">
                            ...
                            <div class="w-full lg:w-[360px]">
                                <div class="relative">
                                    <input type="text" id="searchInput" placeholder="Search departement..."
                            ...
                            <button @click="addModal = true"
                                ...
                                <i class="bi bi-plus-lg mr-2"></i>Add Departement
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="table-auto w-full ">
                        ...
                        <tbody id="TableBody" class="divide-y divide-gray-100">
                            @include('components.admin.departement.table', [
        ...
        @include('components.admin.departement.add', [
            'show' => 'addModal',
        ])
    </div>
    ...
    <script>
        $(document).ready(function() {
            function fetchSearch() {
                ...
                $.ajax({
                    url: "{{ route('departements.filter') }}", // Pastikan route ini dibuat
                    type: "GET",
                    data: {
                        search: search
                    },
