            ...
            <div class="mb-6">
                <div class="flex items-center mb-4">
                    <div class="relative mr-2">
                        <select id="month-select" class="border border-gray-300 rounded-md py-2 px-4 pr-8 appearance-none bg-white">
                    ...
                    <div class="relative">
                        <select id="year-select" class="border border-gray-300 rounded-md py-2 px-4 pr-8 appearance-none bg-white">
                            <option>2024</option>
                            <option>2025</option>
                        </select>
                        <div class="absolute right-3 top-3 pointer-events-none">
                ...
                <div class="mb-6">
                    <div class="grid grid-cols-7 text-center mb-2">
                        <div class="text-sm text-gray-500">Su</div>
                        <div class="text-sm text-gray-500">Mo</div>
                        <div class="text-sm text-gray-500">Tu</div>
                        <div class="text-sm text-gray-500">We</div>
                        <div class="text-sm text-gray-500">Th</div>
                        <div class="text-sm text-gray-500">Fr</div>
                    ...
                    <div class="grid grid-cols-7 gap-1">
                        ...
                        <div class="p-2 text-center bg-green-600 text-white rounded-full">10</div>
                        ...
                        <div class="p-2 text-center">23</div>
                        <div class="p-2 text-center">24</div>
                        <div class="p-2 text-center">25</div>
                        <div class="p-2 text-center">26</div>

                        <div class="p-2 text-center">27</div>
                        <div class="p-2 text-center">28</div>
                        <div class="p-2 text-center">29</div>
                        <div class="p-2 text-center">30</div>
                        <div class="p-2 text-center text-gray-400">1</div>
                        <div class="p-2 text-center text-gray-400">2</div>
                        <div class="p-2 text-center text-gray-400">3</div>
                    </div>
                </div>

                <div class="flex justify-end gap-2 mb-6">
                    <button class="px-3 py-1 border border-gray-300 rounded-md hover:bg-gray-50">Cancel</button>
                    <button class="px-3 py-1 bg-green-600 text-white rounded-md hover:bg-green-700">Done</button>
                </div>
            </div>
