...
<style>
    ...
    #students-table_wrapper .dataTables_length select {
        ...
        padding: 0.375rem 2rem 0.375rem 0.75rem; /* Tambah padding kanan untuk arrow */
        font-size: 14px;
        background: white;
        color: #374151;
        min-width: 80px;
        ...
        background-position: right 0.75rem center; /* Geser arrow lebih ke kiri */
        background-repeat: no-repeat;
        background-size: 1.25em 1.25em; /* Ukuran arrow sedikit lebih kecil */
    }
    ...
    #students-table_wrapper .dataTables_length {
        float: left;
        margin-bottom: 1rem;
        margin-left: 1rem; /* Geser sedikit dari tepi kiri */
        display: block;
    }
    ...
    #stase-filter, #class-filter {
        ...
        background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 20 20'%3e%3cpath stroke='%236b7280' stroke-linecap='round' stroke-linejoin='round' stroke-width='1.5' d='M6 8l4 4 4-4'/%3e%3c/svg%3e");
        background-position: right 0.75rem center; /* Geser arrow 0.75rem dari kanan */
        background-repeat: no-repeat;
        background-size: 1.25em 1.25em; /* Ukuran arrow yang sama */
        cursor: pointer;
    }

    #stase-filter:focus, #class-filter:focus {
        outline: none;
        border-color: #637F26;
        box-shadow: 0 0 0 1px rgba(99, 127, 38, 0.2);
    }

    #stase-filter:hover, #class-filter:hover {
        border-color: #9ca3af;
    }
