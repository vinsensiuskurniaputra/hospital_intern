    ...
    public function filter(Request $request)
    {
        ...
        if ($request->ajax()) {
            return response()->json([
                'table' => view('components.admin.schedule.table-body', compact('allSchedules'))->render(),
                'pagination' => $allSchedules->links()->toHtml()
            ]);
        }

        return redirect()->route('presences.schedules.index');
    }
